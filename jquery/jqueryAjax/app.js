...
// mongoose.connect('mongodb://jiangtao0314:Carriero123@localhost:27017/todo?authSource=admin', { useNewUrlParser: true, useUnifiedTopology: true, useCreateIndex: true })
//     .then(function() {
//         console.log('数据库连接成功');
//     })
//     .catch(function() {
...
app.put('/xml/:id', (req, res) => {
    res.header('content-type', 'text/xml');
    console.log(req.params.id);
    res.send('<students><sid>001</sid><name>张三</name></students>');
})
